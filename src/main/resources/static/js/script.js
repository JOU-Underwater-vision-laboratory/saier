...
// Panel
$(function(){
	//pre promain <div class="bg_pro"> <div class="pro_main"><span class="pro_logo">
$('body').prepend('<div id="advanced"><div class="pro_clear"></div></div></div><div class="bg_pro2"></div></div>');

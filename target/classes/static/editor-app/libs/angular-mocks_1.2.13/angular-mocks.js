 ...
 *
 * *Log*: For fake HTTP backend implementation suitable for end-to-end testing or backend-less
 ...
 *
 * *Log*: For fake http backend implementation suitable for unit testing please see
